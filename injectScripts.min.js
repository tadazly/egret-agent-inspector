            ...
            (function (e) {
                ...
                var u = function () {
                    ...
                    e.checkContainer = function (r, i, n) {
                        ...
                        if (r.scrollRect) {
                            if (i < r.scrollRect.x || n < r.scrollRect.y || i > r.scrollRect.x + r.scrollRect.width || n > r.scrollRect
                                .y + r.scrollRect.height) {
                                return null
                            }
                        } else if (r.mask) {
                    ...
                    e.find = function (t, r) {
                        if (r.hashCode == t || r.name && r.name.toLowerCase().indexOf(t.toString().toLowerCase()) >= 0) return [
                            r];
